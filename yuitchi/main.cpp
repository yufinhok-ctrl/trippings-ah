...
void handleRoot() {
  ...
  html += "<h1>Yuitchi</h1>";
  html += "<p>State: " + myPet.getStateString() + "</p>";
  html += "<p>Hunger: " + String(myPet.getHunger()) + "%</p>";
  html += "<p>Happiness: " + String(myPet.getHappiness()) + "%</p>";
  if (handshakeSuccess) {
    html += "<p>Handshake Captured!</p>";
    html += "<p>SSID: " + targetSSID + "</p>";
    html += "<p>Password: " + capturedPassword + "</p>";
  }
